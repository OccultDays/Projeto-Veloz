"""
Gera a lista de compras de reposição no terminal.
"""
...
class Command(BaseCommand):
    help = "Calcula e imprime a lista de compras para reposição de estoque"
    ...
    def handle(self, *args, **options):
        ...
        if options["detalhado"]:
            self.stdout.write(self.style.MIGRATE_HEADING("=== Detalhamento do Cálculo ==="))
