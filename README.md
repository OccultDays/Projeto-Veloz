...
* **Lista de Compras:** Visualização em formato de código com a saída estrita do edital, botão para cópia rápida com 1 clique para a área de transferência e cards explicativos com as justificativas de cada cálculo.
